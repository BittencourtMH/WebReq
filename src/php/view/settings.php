...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container margin-bottom-medium">
            <h1 class="text-center margin-bottom-medium">Settings</h1>
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="old-password" type="password" placeholder="Current password">
                </div>
                <div class="form-group">
                    <label for="new-password">New password</label>
                    <input class="form-control" id="new-password" type="password" placeholder="New password">
                </div>
                <div class="form-group margin-bottom-medium">
                    <label for="new-password-again">Retype new password</label>
                    <input class="form-control" id="new-password-again" type="password" placeholder="Retype new password">
                </div>
