...
<div class="row my-4">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 px-5">
        ...
        <form id="form" action="../../controller/controller-requirement-new.php" method="post" novalidate>
            ...
            <div class="text-center">
                <button class="btn btn-success mt-4" id="sign-up" type="submit"><?php echo ADD_REQUIREMENT?></button>
            </div>
        </form>
    </div>
</div>
