...
$title=EDIT.' '.$requirement->getName();
...
<div class="row my-4">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 px-5">
        ...
        <form id="form" action="../../controller/controller-requirement-edit.php" method="post">
            <div class="form-group">
                <label for="name"><?php echo NAME?></label>
                <input class="form-control" id="name" name="name" type="text" placeholder="<?php echo NAME?>" value="<?php echo $requirement->getName()?>" oninput="hideValidation(event)" />
